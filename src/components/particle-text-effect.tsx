...
const DEFAULT_WORDS = ["Piyush Gurav", "Full Stack Developer", "UI/UX Designer", "Web Developer" , "Software Developer"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    //   b: Math.random() * 255,
    // }
    const gray = Math.floor(Math.random() * 156) + 100 // gray between 100-255 for visibility
    const newColor = {
      r: gray,
      g: gray,
      b: gray,
